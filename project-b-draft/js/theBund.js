...
function setup() {
  ...
  triviaTwo = new CircleButton(sizeW * random(0.2, 0.8), sizeH * random(0.2, 0.8), "assets/musicTheBund.wav", "The Bund's nightly light show, with music playing in the background, is a mesmerizing blend of history and modernity!");
